...
<head>
  ...
  <title>Fakusa Sport Center - About</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a href="<?php echo base_url(); ?>index.php/c_admin/index"><b>Home</b></a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>index.php/c_admin/about" class="active"><b>About</b></a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>index.php/Welcome/ambilAdmin"><b>Pesanan</b></a>
                    </li>
                    <li>
                        <a href="#"><b>Rekap Diagram</b></a>
                    </li>
                    <li class="dropdown">
