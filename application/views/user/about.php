...
<head>
  ...
  <title>Tono's Futsal - About</title>
  ...
  <body class="tm-gray-bg">
  	<!-- Header -->
        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url(); ?>index.php/c_member/index"><span class="glyphicon glyphicon-record"></span> Tono Futsal</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="<?php echo site_url('c_member/logout'); ?>">Logout</a>
                            </li>
                        </ul>
                    </li>
                </ul>
	...
	<!-- gray bg -->	
	<section class="container tm-home-section-1" style="padding-top: 100px" id="more">
		<div class="row">
			<!-- slider -->
			<div class="flexslider flexslider-about effect2">
			  <ul class="slides">
			    <li>
			      <img src="<?php echo base_url(); ?>assets/img/about-1.jpg" alt="image" />
				...
				<div class="col-lg-12">
					<div class="tm-what-we-do-right">
						<div class="tm-about-box-2 margin-bottom-30">
							<img src="<?php echo base_url(); ?>assets/img/about-2.jpg" alt="image" class="tm-about-box-2-img">
						...
						<div class="tm-about-box-2">
							<img src="<?php echo base_url(); ?>assets/img/about-3.jpg" alt="image" class="tm-about-box-2-img">
							<div class="tm-about-box-2-text">
