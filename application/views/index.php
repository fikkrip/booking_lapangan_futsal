                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="#">089699051373</a>
                            </li>
                            <li>
                                <a href="#">Line : lovenjar</a>
                            </li>
                            <li>
                                <a href="#">Instagram : @fukusafutsal</a>
                            </li>
                            <li>
                                <a href="#">Facebook : FFS FakusaFutsal</a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown">
		  ...
		  <ul class="slides">
		    <li>
			    <div class="tm-banner-inner">
                    <ul>
                      <a href="#more" class="tm-banner-link">Jenis Lapangan</a>
		...
		<div class="row">
			<div class="col-lg-4 col-md-4 col-sm-6">
				<div class="tm-home-box-1 tm-home-box-1-2 tm-home-box-1-left">
					...
					<a href="<?php echo base_url(); ?>index.php/Welcome/ambilJns/1">
...
<h2 class="tm-section-title">Pilih Jenis Lapangan</h2>					
			...
			<div class="col-lg-4 col-md-4 col-sm-6">
				<div class="tm-home-box-1 tm-home-box-1-2 tm-home-box-1-right">
					...
					<a href="<?php echo base_url(); ?>index.php/Welcome/ambilJns/0">
				...
				<div class="col-lg-6">
					<div class="tm-home-box-3">
						...
						<div class="tm-home-box-3-info">
							...
							<a href="<?php echo base_url(); ?>index.php/Welcome/ambil/Lapangan_A" class="tm-home-box-2-link"><span class="tm-home-box-2-description box-3">Lapangan A</span></a>
			     ...
			     <div class="col-lg-6">
			        <div class="tm-home-box-3">
						...
						<div class="tm-home-box-3-info">
							...
							<a href="#" class="tm-home-box-2-link"><i class="fa fa-heart tm-home-box-2-icon border-right"></i></a>
							<a href="<?php echo base_url(); ?>index.php/Welcome/ambil/Lapangan_B" class="tm-home-box-2-link"><span class="tm-home-box-2-description box-3">Lapangan B</span></a>
							<a href="#" class="tm-home-box-2-link"><i class="fa fa-edit tm-home-box-2-icon border-left"></i></a>
						</div>
						</div>						
					</div>
